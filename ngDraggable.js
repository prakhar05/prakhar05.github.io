                ...
                link: function (scope, element, attrs) {
                  ...
                  //  return;
                    ...
                    var onmove = function(evt) {
                        ...
                        _mx = (evt.pageX || evt.originalEvent.touches[0].pageX);
                        _my = (evt.pageY || evt.originalEvent.touches[0].pageY);
                        console.log(element.centerX,element.centerY);
                    ...
                    var reset = function() {
                        element.css({left:'',top:'', position:'relative', 'z-index':'', margin: '', 'max-width':'100%'});
                    }
                    var moveElement = function(x,y) {
                        element.css({left:x,top:y, position:'fixed', 'z-index':99999, margin: '0', 'max-width':'10%'});
                    }
                    initialize();
                }
            }
        ...
        .directive('ngDragClone', ['$parse', '$timeout', function ($parse, $timeout) {
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    var moveElement = function(x,y) {
                        element.css({left:x,top:y, position:'fixed', 'z-index':99999, visibility:'visible', 'max-width':'10%'});
                    }
